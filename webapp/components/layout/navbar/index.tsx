        ...
        <header className="relative z-50 w-full h-24">
            <div
                ...
                <a href="/" className="relative p-8 items-center inline-block h-full font-black leading-none">
                    <span className="ml-3 text-xl text-gray-800">ChatUI<span className="text-pink-500">.</span></span>
                </a>
                ...
                <nav id="nav"
                    ...
                    <Link href="/"><p
                        className="mr-0 font-bold duration-100 md:mr-3 lg:mr-8 transition-color hover:text-indigo-600">Home</p></Link>
                </nav>
